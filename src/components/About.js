    ...
    return <div className='main'>
      ...
      <div className='top'>
        ...
        <div className='about1'>
          ...
          <p> Denise is a graduate of the University of Nebraska and holds a black belt in Mathematics as a Fellow of the Society of Actuaries.  She co-authored the actuarial best-seller, <em>Life, Health and Annuity Reinsurance</em>, now in it's fourth edition.  In 1999, her novel, <em>Calculated Risk</em> won the greater dallas Writer's Association's Most Publishable Novel, the Millard Lampell Award, the Betty Heinrich's Award, and the CNW/FFWA Florida State Novel Chapter and Best in Fiction Division.  Timberwolf Press published Calculated Risk in 2000 and the audio version was a finalist for the 2001 Violet Crow Audio Book award given by the Texas Writers League.</p>
