  ...
  render () {
    return <div className='main'>
      ...
      <div className='synopsis'>
        ...
        <p>Meanwhile, Circe's mother earns a living as Psychic Sybil.  Visit her in her reading room and have your fortune told.</p>
      </div>
      <button className='toGame' type='submit' name='Tarot Game'><Link to='/'>Pyschic Sybil</Link></button>
